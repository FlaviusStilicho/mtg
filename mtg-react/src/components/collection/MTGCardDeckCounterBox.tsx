...
export class MTGCardDeckCounterBox extends Component<MTGCardDeckCounterBoxProps> {
  shouldComponentUpdate(nextProps: MTGCardDeckCounterBoxProps) {
    return hasDeckEntryChanges(
      this.props.card,
      this.props.selectedDeckEntries,
      nextProps.selectedDeckEntries,
    );
  }

  checkCanAddCopy = (isSideboard: boolean = false) => {
    const copiesInDeck = this.props.getCurrentNumberOfCopiesForCard(
      this.props.card,
    );
    const copiesInSideboard = this.props.getCurrentNumberOfCopiesForCard(
      this.props.card,
      true,
    );
    ...
    return (
      <Box style={{ alignItems: "center" }}>
        <Button
          ...
          onClick={() =>
            this.props.updateCardCopiesInDeck(this.props.card, -1, false)
          }
        >
        ...
        <Button
          ...
          onClick={() =>
            this.props.updateCardCopiesInDeck(this.props.card, 1, true)
          }
        >
