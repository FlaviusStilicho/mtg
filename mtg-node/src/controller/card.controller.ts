...
import { AddCategory, MTGCard, RemoveCategory, Update } from "../entity/MTGCard.entity.ts";
import { logger } from "../index.ts"
import { MTGCardDTO, CardQueryParameters, UpdateCardOwnedCopiesQueryParams } from 'mtg-common';
...
export const GetCards = async (req: Request<{}, {}, {}, GetCardsQueryParams>, res: Response) => {
    try {
